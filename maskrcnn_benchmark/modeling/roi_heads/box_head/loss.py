...
class FastRCNNLossComputation(object):
    ...
    def __call__(self, class_logits, box_regression):
        ...
        ### The roi head part also needs to be trained for both the source and target domains.
        ...
        # #### The instance-level domain label is changed to (number of instances 512, number of classes + 1)
        # domain_ins_labels = torch.zeros((domain_masks.shape[0], 17), dtype=torch.uint8)
        # for ins_idx in labels:
        #     domain_ins_labels[ins_idx, labels[ins_idx]] = 1 # Each instance is assigned a binary classification label indicating whether it belongs to the source domain or not, corresponding to its class.
        ...
        # The returned instance-level domain label has the shape (512, 16+1)
        # return classification_loss, box_loss, domain_ins_labels
        return classification_loss, box_loss, domain_masks, labels
